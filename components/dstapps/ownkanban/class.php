...
class OwnKanbanTasks {
  ...
  public static function setTasksStopper($params)
  {
    // return $params;
    global $DB;
    $taskId = $params['taskId'];
    $strSql = "UPDATE `my_own_kanban_tasks` SET stopper ='1' WHERE id='$taskId'";
    $query = $DB->Query($strSql, false);
    return $strSql;
  ...
  public static function unsetTasksStopper($params)
  {
    // return $params;
    global $DB;
    $taskId = $params['taskId'];
    $strSql = "UPDATE `my_own_kanban_tasks` SET stopper ='0' WHERE id='$taskId'";
    $query = $DB->Query($strSql, false);
    return $strSql;
  ...
  public static function getTasksStopperComments($params) {
    global $DB;
    $taskId = $params['taskId'];
    $strSql = "SELECT * FROM `my_own_kanban_tasks_comments` WHERE id='$taskId' ";
  ...
  public static function setTasksStopperComments($params) {
    global $DB;

    $commentsText = $params['commentsText'];
    $taskId = $params['taskId'];
    $userId = $params['userId'];
    $date = $params['date'];

    $strSql = "INSERT INTO `my_own_kanban_tasks_comments` (`task_id`,`user`,`comment_text`,`date`)
    VALUES ('$taskId', '$userId', '$commentsText','$date');";
